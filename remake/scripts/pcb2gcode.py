...
if __name__ == '__main__':
    ...
    parser.add_option('-s', '--stepovers', help='# of isolation paths to engrave', type=int, default=3)
    ...
    parser.add_option('--posts',           help='cut 1/8" post holes for alignment (x or y or none)', type='str', default='none')
    parser.add_option('--fixture_width',   help='width of 2-side fixture', type=float, default=110.0*constants.MM)
